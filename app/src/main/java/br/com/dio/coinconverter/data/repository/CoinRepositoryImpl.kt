...
class CoinRepositoryImpl(private val appDatabase: AppDatabase,private val service: AwesomeService) : CoinRepository {
    ...
    override suspend fun getExchangeValue(coins: String) = flow {
        ...
        try {
            ...
            val json = excep.response()?.errorBody()?.string()
